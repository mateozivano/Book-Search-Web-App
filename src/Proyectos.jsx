import pokImg from "../public/file-pokeball-png-0.png"
import bookIcon from "../public/LogoLibroAbierto.png"
            ...
            <div className="flex flex-col mx-auto mt-8 sm:flex-row">
                <div className="my-10 sm:my-6 mx-auto">
                    <button onClick={pokeLink} className="">
                        <img src={pokImg} className="mx-auto h-32" alt="" />
                        <p>Random Pokemon Team Generator</p>
                    </button>
                </div>
                <div className="my-6 mx-auto">
                    <button onClick={bookAppLink} className="">
                        <img src={bookIcon} className="mx-auto h-32" alt="" />
                        <p>App de búsqueda de libros</p>
                    </button>
                </div>
                <div className="my-6 mx-auto">
                    <button className="">
                        <img src={icon404} className="mx-auto h-32" alt="" />
                        <p>Próximamente</p>
                    </button>
                </div>
                <div className="my-6 mx-auto">
